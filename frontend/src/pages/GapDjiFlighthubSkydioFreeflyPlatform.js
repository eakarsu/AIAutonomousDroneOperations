...
// v0 scaffold for: DJI FlightHub, Skydio, and Freefly platform connectors
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-dji-flighthub-skydio-freefly-platform/run.

export default function DjiFlighthubSkydioFreeflyPlatformPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-dji-flighthub-skydio-freefly-platform/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>DJI FlightHub, Skydio, and Freefly platform connectors</h1>
