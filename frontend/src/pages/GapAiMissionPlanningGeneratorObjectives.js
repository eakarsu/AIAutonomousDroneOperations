...
// v0 scaffold for: No AI mission-planning generator from objectives
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-mission-planning-generator-objectives/run.

export default function AiMissionPlanningGeneratorObjectivesPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-mission-planning-generator-objectives/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI mission-planning generator from objectives</h1>
