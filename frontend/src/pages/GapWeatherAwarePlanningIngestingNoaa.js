...
// v0 scaffold for: Weather-aware planning ingesting NOAA forecasts
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-weather-aware-planning-ingesting-noaa/run.

export default function WeatherAwarePlanningIngestingNoaaPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-weather-aware-planning-ingesting-noaa/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Weather-aware planning ingesting NOAA forecasts</h1>
