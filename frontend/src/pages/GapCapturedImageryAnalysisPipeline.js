...
// v0 scaffold for: No captured-imagery analysis pipeline
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-captured-imagery-analysis-pipeline/run.

export default function CapturedImageryAnalysisPipelinePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-captured-imagery-analysis-pipeline/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No captured-imagery analysis pipeline</h1>
